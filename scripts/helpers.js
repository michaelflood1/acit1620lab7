...
export function setCard() {
    ...
    const  cardnodeparent = cardNode.parentElement
     cardnodeparent.classList.remove('flip')
}
...
export function showCard() {
    ...
    // fadethis.parentElement.classList.add('fade')
    ...
    // animate the card
    // const flipthis = fadethis.parentNode;
    // flipthis.classlist.add('flip')
    // const fadethis = getTiles();
    // fadethis.classList.add('fade')
